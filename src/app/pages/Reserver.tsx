...
export default function Reserver({ onNavigate, onReserveTerrain, onJoinMatch }) {
  ...
  const terrains = [
    ...
    },
    {
      ...
      city: "Rabat",
      price: "1100 DH",
      image: "https://i.pinimg.com/736x/f5/94/e3/f594e3cd6e0605f5e6fae7fa3c9c2055.jpg",
      type: "Terrain synthétique",
    ...
    },
    {
      ...
      city: "Casablanca",
      price: "900 DH",
      image: "https://i.pinimg.com/1200x/3c/e9/74/3ce9746869e5dfb01e58903050b9a181.jpg",
      type: "Gazon naturel",
